					...
					<div class="carDescription">
						<div class="topTitle">
							...
							<a class="carPrice" href="<?php echo get_permalink($id); ?>">
								<span class=""><?php echo $listing_options['price']['value'] ? format_currency($listing_options['price']['value']) : "FREE!?"; ?></span>
							</a>

						</div>
						<a class="carFeatures" href="<?php echo get_permalink($id); ?>">
							<div class="features"><?php echo $post_meta['mileage'] ? $post_meta['mileage'].' miles' : "Brand New"; ?> <?php //echo $post_meta['multi_options']; ?></div>
						</a>
					</div>
				</div>
			</div>
...
if(!function_exists("listing_view")){
	function listing_view($layout, $fake_get = null){
	    ...
	    $vehicle_singular = (isset($lwp_options['vehicle_singular_form']) && !empty($lwp_options['vehicle_singular_form']) ? $lwp_options['vehicle_singular_form'] : __('Chance', 'listings') );
	    $vehicle_plural   = (isset($lwp_options['vehicle_plural_form']) && !empty($lwp_options['vehicle_plural_form']) ? $lwp_options['vehicle_plural_form'] : __('Chances', 'listings') );
	}
}
                ...
                <div id="bottomSection">
                	<div id="resultsBarContainer">
                    	<div class="chances">
							...
							?>
                        	<div class="numChances"><?php echo $listings_count==1 ? '1 chance' : ($listings_count > 9 ? 'many chances' : $listings_count.' chances'); ?></div>
                            <div class="subChances">To Fall in Love</div>
                       	</div>
                        <ul id="resultsBar">
                            <?php
                            if(!empty($get_holder)){
                                ...
                                foreach($get_holder as $filter_type => $filter_val){
                                    if($filter_type!='order'){
                                        ...
                                        <li class="filterOption" data-type="<?php echo $filter_type == 'yr' ? 'year' : $filter_type; ?>">
                                            <a class="filterOptionText" data-type="<?php echo $filter_type == 'yr' ? 'year' : $filter_type; ?>" data-val="<?php echo $filter_val; ?>" href="javascript:void(0);"><?php echo $filter_type == 'price' ? 'max $'.listingNumberAbbreviation($filter_val) : ($filter_type == 'mileage' ? 'max '.listingNumberAbbreviation($filter_val).' miles' : $filter_val); ?></a>
                                    	...
                                    	jQuery(window).load(function(){
											...
											range_<?php echo str_replace(" ", "_", mb_strtolower($singular)); ?>.ionRangeSlider({
												...
												prettify: function(n){
													...
													return n === this.min ? "NEW" : Utilities.numberWithCommas(n) + " MILES"
													<?php }else{ ?>
...
if(!function_exists("listing_content")){
	function listing_content(){
		...
		if(isset($listing_options['price']['value']) && !empty($listing_options['price']['value'])){
			...
			$price_text = !empty($original) ? format_currency($original) : "";
		}
		...
		if(isset($post_meta['multi_options']) && !empty($post_meta['multi_options'])){
			...
			foreach($multi_options as $option){
				...
				$multi_text_all .= "<li><span class=\"fa-li ".strtolower(str_replace(' ', '_', $option))."\"></span> " . $option . "</li>";
        ...
        <div class="wrapper">
            <div id="sb-site">
                                    ...
                                    <table style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width: 200px;">
                                                    <a id="cphMain_cphMain_cphMain_hlShare_Pinterest" href="http://www.pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo $slick_full; ?>&amp;description=<?php the_title(); ?>" target="_blank" style="cursor: pointer;">
                                                        <div class="sprite_share bt_pinterest"></div>
                                                    </a>
                                                    <a id="cphMain_cphMain_cphMain_hlShare_Twitter" href="https://twitter.com/share?url=<?php the_permalink(); ?>&amp;text=<?php the_title(); ?>" target="_blank" style="cursor: pointer;">
                                                        <div class="sprite_share bt_twitter"></div>
                                                    </a>
                                                    <a id="cphMain_cphMain_cphMain_hlShare_Facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank" style="cursor: pointer;">
                ...
                <div class="carSliderConten not-wide">
                    <div class="carSlider">
                ...
                <div id="main" class="main">
                    <div class="container" id="content">
                        <div class="row">
                            <div class="7u ajuste7u">

                                <?php /* if(rwmb_meta('listing_test_drive_title') || rwmb_meta('listing_money_back_title') || rwmb_meta('listing_full_warranty_title') || rwmb_meta('listing_dt_warranty_title')){ ?>

                                <div class="iconsGuarantee">
                                    <div class="iconsGuaranteeConten only-wide">

                                    	<?php if(rwmb_meta('listing_test_drive_title')){ ?>
                                        <a href="javascript:void(0)" onClick="" class="tooltip a_adjust_tooltip">
                                            <div class="adjust_tooltips">
                                                <span class="bold"><?php echo rwmb_meta('listing_test_drive_title'); ?></span>
                                                <hr>
                                                <p><?php echo rwmb_meta('listing_test_drive_content'); ?></p>
                                            </div>
                                            <iconbut class="icoDove"></iconbut>
                                        </a>
            							<?php } ?>
                                        <?php if(rwmb_meta('listing_money_back_title')){ ?>
                                        <a href="javascript:void(0)" onClick="" class="tooltip a_adjust_tooltip">
                                            <div class="adjust_tooltips">
                                                <span class="bold"><?php echo rwmb_meta('listing_money_back_title'); ?></span>
                                                <hr>
                                                <p><?php echo rwmb_meta('listing_money_back_content'); ?></p>
                                            </div>
                                            <iconbut class="ico10days"></iconbut>
                                        </a>
                                        <?php } ?>
            							<?php if(rwmb_meta('listing_full_warranty_title')){ ?>
                                        <a href="javascript:void(0)" onClick="" class="tooltip a_adjust_tooltip">
                                            <div class="adjust_tooltips">
                                                <span class="bold"><?php echo rwmb_meta('listing_full_warranty_title'); ?></span>
                                                <hr>
                                                <p><?php echo rwmb_meta('listing_full_warranty_content'); ?></p>
                                            </div>
                                            <iconbut class="icoFull"></iconbut>
                                        </a>
                                        <?php } ?>
                                        <?php if(rwmb_meta('listing_dt_warranty_title')){ ?>
                                        <a href="javascript:void(0)" onClick="" class="tooltip a_adjust_tooltip">
                                            <div class="adjust_tooltips">
                                                <span class="bold"><?php echo rwmb_meta('listing_dt_warranty_title'); ?></span>
                                                <hr>
                                                <p><?php echo rwmb_meta('listing_dt_warranty_content'); ?></p>
                                            </div>
                                            <iconbut class="icoDrivetrain featuremarginNone"></iconbut>
                                        </a>
                                        <?php } ?>
                                    </div>
                                    <div class="iconsGuaranteeConten not-wide">
                                    	<?php if(rwmb_meta('listing_test_drive_title')){ ?>
                                        	<iconbut class="icoDove see_pop_up_shield" relax="shield_01"></iconbut>
                                        <?php } ?>
                                         <?php if(rwmb_meta('listing_money_back_title')){ ?>
                                        <iconbut class="ico10days see_pop_up_shield" relax="shield_02"></iconbut>
                                        <?php } ?>
                                        <?php if(rwmb_meta('listing_full_warranty_title')){ ?>
                                        <iconbut class="icoFull see_pop_up_shield" relax="shield_03"></iconbut>
                                        <?php } ?>
                                        <?php if(rwmb_meta('listing_dt_warranty_title')){ ?>
                                        <iconbut class="icoDrivetrain featuremarginNone see_pop_up_shield" relax="shield_04"></iconbut>
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div id="accordion-section">
                                    ...
                                    if($first_tab){
                                        ...
                                        <div class="technology">
                                            <div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3"><?php echo $first_tab; ?></strong>?</h3>
                                        </div>
                                        <div class="thelanguage" id="vehicle">
                                            <div class="txt16" style="line-height: 22px;">
                                                <?php the_content(); ?>
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    if($second_tab){
                                        ...
                                        <div class="technology">
                                            <div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3"><?php echo $second_tab; ?></strong>?</h3>
                                        </div>
                                        <div class="thelanguage features_and_options" id="features">
                                            <ul class="fa-ul">
                                                <?php echo $multi_text; ?>
                                            </ul>
                                        </div>
                                    ...
                                    if($third_tab){
                                        ...
                                        <div class="technology">
                                            <div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3"><?php echo $third_tab; ?></strong>?</h3>
                                        </div>
                                        <div class="thelanguage" id="technical">
                                    ...
                                    if($fourth_tab){
                                        ...
                                        <div class="technology">
                                            <div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3"><?php echo $fourth_tab; ?></strong>?</h3>
                                        </div>
                                        <div class="thelanguage" id="location">
                                            <?php
                                    ...
                                    if(isset($lwp_options['display_vehicle_video']) && $lwp_options['display_vehicle_video'] == 1 && !empty($listing_options['video'])){
                                        ...
                                        <div class="technology">
                                        	<div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3">Vehicle Video</strong></h3>
                                        </div>
                                        <?php
										...
										?>
                                        <div class="thelanguage" id="vehicle_video">
                                        	<div class="txt16">
									...
									if(isset($lwp_options['fuel_efficiency_show']) && $lwp_options['fuel_efficiency_show'] == 1){
                                        ...
                                        <div class="technology">
                                        	<div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3">Fuel Efficiency Show</strong></h3>
                                        </div>
                                        <div class="thelanguage" id="fuel_efficiency_show">
                                            <div class="efficiency-rating text-center padding-vertical-15 margin-bottom-40">
                                                <ul>
                                                    ...
                                                    <li class="city_mpg"><?php echo (isset($listing_options['city_mpg']['text']) && !empty($listing_options['city_mpg']['text']) ? $listing_options['city_mpg']['text'] : ""); ?>: <strong><?php echo (isset($listing_options['city_mpg']['value']) && !empty($listing_options['city_mpg']['value']) ? $listing_options['city_mpg']['value'] : __("N/A", "listings")); ?></strong></li>
                                                    <li class="fuel"><img src="<?php echo $fuel_icon; ?>" alt="" class="aligncenter"></li>
                                                    <li class="hwy_mpg"><?php echo (isset($listing_options['highway_mpg']['text']) && !empty($listing_options['highway_mpg']['text']) ? $listing_options['highway_mpg']['text'] : ""); ?>: <strong><?php echo (isset($listing_options['highway_mpg']['value']) && !empty($listing_options['highway_mpg']['value']) ? $listing_options['highway_mpg']['value'] : __("N/A", "listings")); ?></strong></li>
                                                </ul>
									...
									if($fifth_tab){
                                        ...
                                        <div class="technology">
                                            <div class="ico_arrow_closed sprite_carpage"></div>
                                            <h3 class="txt24 light technology_adjust2 technology_adjust3"><?php echo $fifth_tab; ?></strong>?</h3>
                                        </div>
                                        <div class="thelanguage" id="comments">
                                ...
                                <div class="greyBorder">
                                    <div class="inspectorProfile2">
                                        <div class="text-center">
                                            ...
                                            <div class="not-mobile btBordeCelesteBuyNow celeste txt18 blueButton" id="open-buyform-btn"><strong>Contact Us!</strong></div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="variant_conten_mobile only-mobile">
        <div class="container" id="content">
            <div class="row">
                <section class="12u">
                ...
                <div class="feature_spec_txt" id="shield_02">
                    ...
                    <div class="feature_spec_txt" id="shield_03">
                        ...
                        <div class="guarantee_text">
                            ...
                            <span id="cphMain_cphMain_cphMain_lblFullWarranty_Time_Mobile">12 months / 11,500 miles</span>
                        </div>
                    </div>
                    ...
                    <div class="feature_spec_txt" id="shield_04">
                        ...
                        <div class="guarantee_text">
                            ...
                            <span id="cphMain_cphMain_cphMain_lblDrivetrainWarranty_Time_Mobile">36 months / 35,500 miles</span>
                        </div>
                    </div>
    ...
    <div id="pop_up_share" class="pop_up_share">
        <div class="pop_up_share_conten">
            ...
            <div class="feature_spec_conten">
                ...
                <a id="cphMain_cphMain_cphMain_hlShare_Facebook4" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank" style="cursor: pointer;">
                ...
                <a id="cphMain_cphMain_cphMain_hlShare_Twitter4" href="https://twitter.com/share?url=<?php the_permalink(); ?>&amp;text=<?php the_title(); ?>" target="_blank" style="cursor: pointer;">
                    <div class="module_share_conten">
                        <div class="sprite_share bt_twitter"></div>
                ...
                <a id="cphMain_cphMain_cphMain_hlShare_Pinterest4" href="http://www.pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&amp;media=<?php echo $slick_full; ?>&amp;description=<?php the_title(); ?>" target="_blank" style="cursor: pointer;">
                    <div class="module_share_conten">
                        <div class="sprite_share bt_pinterest"></div>
...
if(!function_exists("bottom_page_box")){
	function bottom_page_box($layout = false, $load = false, $fake_get = null, $additional_vars = array(), $load_posts = false){
		...
		if($load != false && !empty($load)){
			...
			$return .= '<div class="pagination_container text-center ' . (isset($additional_classes) && !empty($additional_classes) ? " " . $additional_classes : "") . '">';
		}
